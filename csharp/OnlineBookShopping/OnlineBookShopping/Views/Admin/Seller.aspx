<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Seller.aspx.cs" Inherits="OnlineBookShopping.Views.Admin.Seller" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Mycontent" runat="server">
    ...
    <div class="row">
        <div class="col"> <h3 class="text-left">Manage Sellers</h3> </div>
       </div>
