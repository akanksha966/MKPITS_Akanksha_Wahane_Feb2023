<%@ Page EnableEventValidation="false"Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="proddetails.aspx.cs" Inherits="Shopsite2.proddetails" %>
...
<tr>
<td >
<asp:Button OnClick="Button1_Click" ID="ImageButton1" runat="server" Text="Add To Cart"

Height="50px" Width="200px" />
</td>
<td >

<asp:Button OnClick="Button2_Click" ID="Button2" runat="server" Text="view cart" Height="50px"
